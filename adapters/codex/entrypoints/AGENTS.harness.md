...
Read `harness-kit/core/intent-routing.md` — 意图路由表（单一真相源）。

如果 state.json 显示未完成的 WU：先问用户是否继续。

## 多平台协作

如果已有其他平台活跃：选未被占用的 module 注册。遵循 `harness-kit/core/multi-leader-protocol.md`。

## 规范优先级

1. `harness-kit/core/intent-routing.md`
2. 本文件
...
Read `harness-kit/core/karpathy-guidelines.md` — 编码行为准则。改 Java 前速读 `harness-kit/references/README.md`。
